...
/// extends : 일반적인 클래스를 상속 받을때 사용
/// mixin : 한개의 클래스와 두개 이상의 인터페이스를 동시에 상속 받을때
/// with : 현재는 한개의 클래스를 상속받지만,
///         ChangeNotifier 가 자체적으로 상속 받았던 클래스와 인터페이스를 모두 상속 받기
class ThemeController with ChangeNotifier {
  final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();

  /// ThemeMode 클래스를 사용한 객체 선언
  /// flutter 에서 material3의 theme 를 쉽게 변경 할 수 잇도록 미리 준비 해둔 클래스
  late ThemeMode _themeMode; // private 변수
  // private 변수를 외부에서 참조할 수 있는 getter 함수 선언
